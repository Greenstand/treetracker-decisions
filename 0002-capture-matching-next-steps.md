...
### 8. Develop sets of matched images under controlled circumstances for testing any of the above solutions

To test the efficacy of any solution we need to know how it performs on real world data for which the identity of images is known.  Such data sets should be generated by working with an organization to re-find all initial plantings and indicate in the notes field which seedling has been photographed in the re-capture images. Some form of physical tagging would be need for the planters to know for certain which plant was which.  Suggested size of test set: 100-200 seedlings in an area of ~1 ha.  Several such sets should be developed in different sites/countries, and with different periods of time between the planting and revisiting.
### 8. Duplicate detection mode
